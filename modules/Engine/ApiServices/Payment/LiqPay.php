...
namespace App\Engine\ApiServices\Payment;
...
class LiqPay
{
    ...
    public function __construct($public_key, $private_key, $api_url = null)
    {
        ...
        if (empty($public_key)) {
            ...
            throw new InvalidArgumentException('Liqpay Api : public_key is empty');
        }

        if (empty($private_key)) {
            throw new InvalidArgumentException('Liqpay Api :  private_key is empty');
        }
